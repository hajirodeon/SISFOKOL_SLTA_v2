...
if ($HTTP_POST_VARS['btnBR'])
	...
	//re-direct
	$ke = "pel_entry.php?tapelkd=$tapelkd&smtkd=$smtkd&kelkd=$kelkd&progkd=$progkd&rukd=$rukd";
	xloc($ke);	
	}
...
if ($HTTP_POST_VARS['btnNUL'])
	...
	//re-direct
	$ke = "$filenya?tapelkd=$tapelkd&smtkd=$smtkd&kelkd=$kelkd&progkd=$progkd&rukd=$rukd";
	xloc($ke);
	}	
...
do
	...
	echo '<option value="'.$filenya.'?tapelkd='.$tapelkd.'&smtkd='.$smtkd.'&kelkd='.$kelkd.'&progkd='.$prg_kd.'">'.$prg_prog.'</option>';
	}
...
do
	...
	echo '<option value="'.$filenya.'?tapelkd='.$tapelkd.'&smtkd='.$smtkd.'&kelkd='.$kelkd.'&progkd='.$progkd.'&rukd='.$ru_kd.'">'.$ru_ru.'</option>';
	}
	...
	do
		...
		do
			...
			if ($tdte != 0)
				...
				<br>
				[<a href="pel_entry.php?s=edit&kd='.$dte_kd.'&tapelkd='.$tapelkd.'&smtkd='.$smtkd.'&kelkd='.$kelkd.'&progkd='.$progkd.'&rukd='.$rukd.'">EDIT</a>
				 - 
				 <a href="'.$filenya.'?s=hapus&kd='.$dte_kd.'&tapelkd='.$tapelkd.'&smtkd='.$smtkd.'&kelkd='.$kelkd.'&progkd='.$progkd.'&rukd='.$rukd.'">HAPUS</a>].
				</td>';
				}
			else
				{
