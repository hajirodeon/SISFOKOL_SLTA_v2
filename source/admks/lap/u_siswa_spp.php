...
$ke = "$filenya?tapelkd=$tapelkd&kelkd=$kelkd&progkd=$progkd&rukd=$rukd&page=$page";
...
if (empty($tapelkd))
	...
	if ($count != 0)
		...
		<tr>
		<td>
		<a href="u_siswa_spp_pdf.php?tapelkd='.$tapelkd.'&kelkd='.$kelkd.'&progkd='.$progkd.'&rukd='.$rukd.'" target="_blank">
