...
function Header()
{
	...
	//pelajaran
	$qpela = mysql_query("SELECT * FROM m_mapel ".
							"WHERE kd = '$mapelkd'");
	$rpela = mysql_fetch_assoc($qpela);
	$pela_mapel = balikin($rpela['pel']);
	...
	$this->SetY(10);
	$this->SetX(140);
	$this->Cell(40,5,'Program ',0,1,'L');

	$this->SetY(15);
	$this->SetX(140);
	$this->Cell(40,5,'Semester ',0,1,'L');
	...
	$this->SetY(10);
	$this->SetX(180);
	$this->Cell(25,5,': '.$program.'',0,1,'L');
	
	$this->SetY(15);
	$this->SetX(180);
	$this->Cell(25,5,': '.$smt.'',0,1,'L');
	...
	if ($this->PageNo() == 1)
		...
		$this->WriteHTML('<table>'.
							'<tr><td width="750" ALIGN="CENTER">KOLEKSI NILAI Per SEMESTER</td></tr>'.
							'<tr><td width="750" ALIGN="CENTER">Mata Pelajaran : '.$pela_mapel.'</td></tr>'.
							'</table>');
		}
