...
function cegah($str) 
	...
	$str = ereg_replace("'", "xpsijix", $str);
	$str = ereg_replace("@", "xtkeongx", $str);
	$str = ereg_replace("%", "xpersenx", $str);
	$str = ereg_replace("_", "xgwahx", $str);
	$str = ereg_replace("1=1", "x1smdgan1x", $str);
	$str = ereg_replace("/", "xgmringx", $str);
	$str = ereg_replace("!", "xpentungx", $str);
	$str = ereg_replace("<", "xkkirix", $str);
	$str = ereg_replace(">", "xkkananx", $str);
	$str = ereg_replace("{", "xkkurix", $str);
	$str = ereg_replace("}", "xkkurnanx", $str);
	$str = ereg_replace(";", "xkommax", $str);
	$str = ereg_replace("-", "xstrix", $str);
	$str = ereg_replace("_", "xstripbwhx", $str);
	return $str;
  	}
...
function nosql($str) 
	...
	////////////////// berikut, tidak layak di-balikin
	$str = ereg_replace("select ", "xtselectx", $str);
	$str = ereg_replace("delete ", "xtdeletex", $str);
	$str = ereg_replace("update ", "xtupdatex", $str);
	$str = ereg_replace("alter ", "xtalterx", $str);
	$str = ereg_replace("insert ", "xtinsertx", $str);
	$str = ereg_replace("grant ", "xtgrantx", $str);
	return $str;
  	}
...
function balikin($str) 
	...
	$str = ereg_replace("xpersenx", "%", $str);
	$str = ereg_replace("xtkeongx", "@", $str);
	$str = ereg_replace("xgwahx", "_", $str);
	$str = ereg_replace("x1smdgan1", "1=1", $str);
	$str = ereg_replace("xgmringx", "/", $str);
	$str = ereg_replace("xpentungx", "!", $str);
	$str = ereg_replace("xpsijix", "'", $str);
	$str = ereg_replace("xkkirix", "<", $str);
	...
	$str = ereg_replace("xkommax", ";", $str);
	$str = ereg_replace("xstrix", "-", $str);
	$str = ereg_replace("xstripbwhx", "_", $str);
...
function balikin2($str) 
	...
	$str = ereg_replace("xtkeongx", "@", $str);
	$str = ereg_replace("xgwahx", "_", $str);
	$str = ereg_replace("x1smdgan1x", "1=1", $str);
	$str = ereg_replace("xgmringx", "/", $str);
	$str = ereg_replace("xpentungx", "!", $str);
	$str = ereg_replace("xpsijix", "'", $str);
	$str = ereg_replace("xkkirix", "<", $str);
...
//META //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
$author = "Agus Muhajir (hajirodeon@yahoo.com)";
$description = "Sistem Informasi Sekolah (SISFOKOL).";
$url = "http://sisfokol.wordpress.com";
$keywords = "sistem, informasi, sekolah, sisfokol, biasawae";
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////



//VERSI /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
$versi = "SISFOKOL_SLTA_v2.0";
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
?>